...
An official repository for amCharts JavaScript Stock Chart V2 (free version).

**NOTE:** This is an old unsupported version. Use it at your own risk.
...
```
bower install amcharts2
```

## Usage

Include `amstock.js` on your web site:

```
<script src="/bower_components/amstock2/amcharts/amstock.js"></script>
```
